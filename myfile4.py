...
def retiming():
  node_list_a = []
  node_list_b = []
  search_shita('_49081_', 2, node_list_a, node_list_b)
  print("っこ")
  print(node_list_a, node_list_b)
  important_node = node_list_a[1]
  print("important_node")
  print(important_node)
  node_list_a = []
  node_list_b = []
  search_ue('_49081_', 2, node_list_a, node_list_b)
  search_shita('_49081_', 2, node_list_a, node_list_b)
  print(node_list_a, node_list_b)
  ...
  g.add_edge(target_node_a, '_49081_')
  g.add_edge(target_node_b, '_49081_')

  print('\n')
  node_list_a = []
  node_list_b = []
  search_ue('_49080_', 2, node_list_a, node_list_b)
  print('\n')
  print("49080について")
  print(node_list_a)
  print(node_list_b)
  ...
  g.add_edge(target_node_c, '_49080_')

  print('\n')
  print("!!!!!!!!", end='\n')
  node_list_a = []
  node_list_b = []
  search_shita('_49080_', 3, node_list_a, node_list_b)
  print(node_list_a)
  print(node_list_b)
  under_node = node_list_a[0]
  del_node_d = node_list_a[1:3]
  print("under_node")
  print(under_node)
  print("del_node_d")
  print(del_node_d)
  vain_node = del_node_d[1]
  print("vain_node")
  print(vain_node)
  node_list_a = []
  node_list_b = []
  search_shita(vain_node, 2, node_list_a, node_list_b)
  print("")
  print(node_list_a)
  print(node_list_b)
  target_node_d = node_list_a[0]
  print("target_node_d")
  print(target_node_d)
  for i in range(len(del_node_d)):
    g.remove_node(del_node_d[i])
  g.add_edge(under_node, target_node_d)
...
def main():
  ...
  # is_connected()
  print("######", end='\n')
  print(list(g.successors("__muladd_madd_125.madd._madd")))
  print(list(g.predecessors("_49086_")))
  print(list(g.out_edges("__muladd_madd_125.madd._madd")))
  print(list(g.in_edges("_49086_")))
  retiming()
  print("######", end='\n')
  print(list(g.successors("__muladd_madd_125.madd._madd")))
  print(list(g.predecessors("_49086_")))
      ...
      for i in range(len(node_lists)):
        ...
        for j in range(len(n)):
          ...
          if g.nodes[m]["kind"] == "add":
            # print(node)
            print(m)
  mul_lisit = ["_49074_","_49081_","_49088_","_49095_","_49102_","_49109_","_49116_","_49123_","_49130_"]
  add_list = []
  """
