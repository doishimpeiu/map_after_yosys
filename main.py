...
def search_ue(key, count, node_list_a, node_list_b):
  ...
  # print(list(g.predecessors("__substreamoutput_data_861")))
  # print(list(g.successors("__substreamoutput_data_861")))
  #このリストの中の要素が複数の場合どうするか？
  if len(next_node) > 1:
...
def retiming1(add_node):
  ...
  node_list_a = []
  node_list_b = []
  search_ue(add_node, 2, node_list_a, node_list_b)
  # print(node_list_a)
  # print(node_list_b)
  del_node_a = node_list_a[:2]
  del_node_b = node_list_b[:2]
  # print(f"del_node_a:{del_node_a}")
  # print(f"del_node_b:{del_node_b}")
  node_list_a = []
  node_list_b = []
  # print(node_list_a)
  # print(node_list_b)
  vain_list = search_ue_1(del_node_a[-1], node_list_a)
  target_node_a = vain_list[0]
  vain_list = search_ue_1(del_node_b[-1], node_list_b)
  target_node_b = vain_list[0]
  # print(node_list_a)
  # print(node_list_b)
  # print(del_node_a[-1])
  # print(del_node_b[-1])
  # print(f"target_node_a:{target_node_a}")
  # print(f"target_node_b:{target_node_b}")
  #ノードを消してつなぎ直す
  for i in range(len(del_node_a)):
    if del_node_a[i] == "__substreamoutput_data_861":
      print("ここや！1")
      input()
    g.remove_node(del_node_a[i])
  for i in range(len(del_node_b)):
    if del_node_b[i] == "__substreamoutput_data_861":
      print("ここや！2")
      input()
    g.remove_node(del_node_b[i])
  g.add_edge(target_node_a, add_node)
  g.add_edge(target_node_b, add_node)
  #出力について
  # print(list(g.successors(add_node)))
  node_list_a = []
  node_list_b = []
  node_list_c = []
  node_list_d = []
  node_list_e = []
  node_list_d = search_shita_1(add_node, node_list_a)
  under_node = node_list_d[0]
  # print("\n")
  # print(f"under_node:{under_node}")
  node_list_d = search_shita_1(under_node, node_list_b)
  # print("\n")
  target_node_d = node_list_d[0]
  # print(f"target_node_d:{target_node_d}")
  node_list_c = search_shita_1(target_node_d, node_list_e)
  target_wire_d = node_list_c[0]
  # print("\n")
  # print(f"target_wire_d:{target_wire_d}")
  #辺の削除
  g.remove_edge(under_node, target_node_d)
  #ノードの複製
  created_node = "created_node_" + str(created_number)
  ...
  #確認
  # print("繋がってるか確認")
  # print(list(g.successors(target_node_a)))
  # print(list(g.successors(target_node_b)))
  # print(list(g.successors(add_node)))
  # print(list(g.successors(under_node)))
  # print(list(g.successors(created_node)))
  # print(list(g.successors(created_wire)))
  # print(list(g.successors(target_node_d)))
  # print(list(g.predecessors(target_node_d)))
  # print(list(g.successors(target_wire_d)))
  # print("上が繋がっているか確認")
  # print(f"add_nodeの上:{list(g.predecessors(add_node))}")
  # input()

#muxをリタイミングする関数
def retiming2(mux_node):
  global created_number
  # print("retiming2に入りました")
  # print(f"mux_node:{mux_node}")
  pre_list = list(g.predecessors(mux_node))
  # print(pre_list)
  # input()
  node_list_a = []
  node_list_b = []
  search_ue(pre_list[0], 2, node_list_a, node_list_b)
  # print(node_list_a)
  # print(node_list_b)
  # input()
  del_list_a = []
  del_list_a.append(pre_list[0])
  del_list_a.append(node_list_a[0])
  # print("del_list_a")
  # print(del_list_a)
  # input()
  node_list_a = []
  node_list_b = []
  search_ue(pre_list[1], 2, node_list_a, node_list_b)
  # print(node_list_a)
  # print(node_list_b)
  del_list_b = []
  del_list_b.append(pre_list[1])
  del_list_b.append(node_list_a[0])
  # print("del_list_b")
  # print(del_list_b)
  # input()
  node_list_a = []
  node_list_b = []
  search_ue(pre_list[2], 2, node_list_a, node_list_b)
  # print(node_list_a)
  # print(node_list_b)
  del_list_c = []
  del_list_c.append(pre_list[2])
  del_list_c.append(node_list_a[0])
  # print("del_list_c")
  # print(del_list_c)
  # input()
  node_list_a = []
  ...
  # print(node_list_a)
  # print(node_list_b)
  vain_list = search_ue_1(del_list_a[-1], node_list_a)
  target_node_a = vain_list[0]
  # print("target_node_a")
  # print(target_node_a)
  # input()
  vain_list = search_ue_1(del_list_b[-1], node_list_b)
  target_node_b = vain_list[0]
  # print("target_node_b")
  # print(target_node_b)
  # input()
  vain_list = search_ue_1(del_list_c[-1], node_list_c)
  target_node_c = vain_list[0]
  # print("target_node_c")
  # print(target_node_c)
  # input()
  #ノードを消してつなぎ直す
  for i in range(len(del_list_a)):
    g.remove_node(del_list_a[i])
  for i in range(len(del_list_b)):
    g.remove_node(del_list_b[i])
  for i in range(len(del_list_c)):
    g.remove_node(del_list_c[i])
  g.add_edge(target_node_a, mux_node)
  g.add_edge(target_node_b, mux_node)
  g.add_edge(target_node_c, mux_node)
  #出力について
  # print(list(g.successors(mux_node)))
  node_list_a = []
  node_list_b = []
  node_list_c = []
  node_list_d = []
  node_list_e = []
  node_list_d = search_shita_1(mux_node, node_list_a)
  under_node = node_list_d[0]
  # print("\n")
  # print(f"under_node:{under_node}")
  # input()
  ...
  # print(list(g.successors(target_wire_d)))
  # print("上が繋がっているか確認")
  # print(f"add_nodeの上:{list(g.predecessors(mux_node))}")
  # input()

def can_retiming(example_node):
  global ccout
  retiming3 = "retiming3"
  res = True
  # print("can_retiming関数の中")
  # print(example_node)
  # print(g.nodes[example_node]["kind"])
  upper_wires = list(g.predecessors(example_node))
  under_wires = list(g.successors(example_node))
  # print(f"upper_wires:{upper_wires}")
  # print(f"under_wires:{under_wires}")
  ####上をみる
  for upper_wire in upper_wires:
    if type(upper_wire) == int:
      # print("数字が入ってもうてます")
      # print(f"upper_wire:{upper_wire}")
      # input()
      return False
    if len(list(g.successors(upper_wire))) != 1: #ワイヤーが2つ以上のノードに繋がっている時
      # print("ワイヤーがノードに繋がっていないか, ２つ以上のノードに繋がってます")
      # print(f"upper_wire:{upper_wire}")
      # print(f"upper_wireの下のノード:{list(g.predecessors(upper_wire))}")
      # input()
      return False
    if len(list(g.predecessors(upper_wire))) != 1:
      # print("複数入力もしくはワイヤーがノードに繋がっていないです")
      # print(f"upper_wireの上のノード:{list(g.predecessors(upper_wire))}")
      # input()
      return False
    upper_nodes = list(g.predecessors(upper_wire))
    # print(f"upper_nodes:{upper_nodes}")
    ...
    # print("upper_nodes")
    # print(upper_nodes)
    # # print(type(upper_nodes))
    upper_node = upper_nodes[0]
    # print("upper_node")
    # print(upper_node)
    if type(upper_node) == int:
      # print("数字入ってもうてますがな")
      # print(f"upper_node:{upper_node}")
      # input()
      return False
    # input()
    # print("種類")
    # print(g.nodes[upper_node]["kind"])
    ccout = ccout + 1
    # print(f"ccout:{ccout}")
    if g.nodes[upper_node]["kind"] == "sdff":
      pass
    elif g.nodes[upper_node]["kind"] == "dff":
      pass
    else:
      res = False
  ####下をみる
  # print(f"under_wires:{under_wires}")
  for under_wire in under_wires:
    if type(under_wire) == int:
      # print("数字に入ってもうてます")
      # print(f"under_wire:{under_wire}")
      return False
    if len(list(g.successors(under_wire))) != 1:
      # print("複数出力")
      # print(list(g.successors(under_wire)))
      # input()
      return False
    under_nodes = list(g.successors(under_wire))
    # print(f"under_node{under_nodes}")
    # print("under_nodes")
    # print(under_nodes)
    under_node = under_nodes[0]
    # print(under_node)
    # print(under_node)
    if type(under_node) == int:
      # print("数字が入ってまっせ")
      # print(f"under_node:{under_node}")
      # input()
      return False
    # print("種類")
    # print(g.nodes[under_node]["kind"])
    if g.nodes[under_node]["kind"] == "sdff":
      pass
    elif g.nodes[under_node]["kind"] == "dff":
      pass
    elif g.nodes[under_node]["kind"] == "add":
      retiming3 = "add"
      return retiming3
    elif g.nodes[under_node]["kind"] == "mul":
      retiming3 = "mul"
      return retiming3
    elif g.nodes[under_node]["kind"] == "mux":
      retiming3 = "mux"
      return retiming3
    else:
      # print("ramとかに入ってもうてます")
      # input()
      retiming3 = "else"
      return retiming3
  # print("\n")
...
def main():
  ...
  path = '/Users/doishinpei/workspace/map_after_yosys/presynthesis_sdff2.v'
  with open(path) as f:
      ...
      for i in range(len(node_lists)):
        ...
        for j in range(len(n)):
          ...
          if g.nodes[m]["kind"] == "add":
            # print(node)
            madd_list.append(node)
  # print("madd_list")
  # print(madd_list)
  # input()
  add_list = []
  for node in nx.nodes(g):
    if g.nodes[node]["kind"] == "add":
      # print(node, end="\n")
      # input()
  ...
  mux_list = []
  for node in nx.nodes(g):
    if g.nodes[node]["kind"] == "mux":
      mux_list.append(node)
  # print("mux_list")
  # print(mux_list)
  ######################################
  ###卒論と同じ箇所のリタイミング
  #####################################
  madd_list.pop(0)  #madd_0を削除
  # print("maddの中身")
  # print(madd_list)
  # input()
  #madd1〜8のリタイミング
  for j in range(2):
    for i in range(len(madd_list)):
      mul_node = madd_list[i]
      retiming(mul_node)
      # print("######", end='\n')
  ...
  index = 0
  total = 0
  add_mux_list = add_list + mux_list
  while True:
    ret_count = 0
    for example_node in add_mux_list:
      # print(f"インデックス:{index}")
      # print(f"example_node:{example_node}")
      res = can_retiming(example_node)
      res_list.append(res)
      if res == "add":
        ...
        print("resはmux")
        # input()
      elif res == "else": #帰ってきた値がadd, mul, muxではない場合
          print("変なの帰ってきてもうてます")
          print(res)
          input()
      elif res == True: #リタイミング条件に合っているので, リタイミングしていくぅ!
        # print(f"{example_node}をリタイミングしていきます")
        # print(g.nodes[example_node]["kind"])
        if g.nodes[example_node]["kind"] == "add":
          retiming1(example_node)
          ret_count = ret_count + 1
          # input()
        elif g.nodes[example_node]["kind"] == "mux":
          retiming2(example_node)
          ret_count = ret_count + 1
        else:
          print("変なエラー")
          input()
